package com.sundy.sundyutils.view.toast;
...
public final class ToastTools {
	...
	public static void showToast(int resId) {
		showToast(myApp.getString(resId));
	}
	...
	public static void showToast(String content, int duration) {
		if (mToast == null) {
			mToast = Toast.makeText(myApp, content, Toast.LENGTH_SHORT);
		} else {
	...
	public static void showLazzToast(int resId) {
		showLazzToast(myApp.getString(resId));
	}
	...
	public static void showLazzToast(String content) {
		Toast.makeText(myApp, content, Toast.LENGTH_SHORT).show();
	}
